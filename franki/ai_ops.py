"""
ai_ops.py — AI-powered inline operations invoked by slash commands.

Handles: /compact, /payload, /tools, /explain, and the non-streaming /report
variant used in testing. For the streaming /report command used in the REPL,
see reporter.py.
"""
...
def run_compact(cfg: FrankiConfig, session: "Session") -> None:
    ...
    console.print(Text(
        f"  History compacted. Context reduced from {original} to 1 messages.",
        style=GOLD,
    ))
